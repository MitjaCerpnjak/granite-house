...
namespace GraniteHouse.Areas.Customer.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        {
            List<int> lstShoppingCart = HttpContext.Session.Get<List<int>>("shoppingCartSession");
        ...
        {
            List<int> lstCartItems = HttpContext.Session.Get<List<int>>("shoppingCartSession");
            ...
            HttpContext.Session.Set("shoppingCartSession", lstCartItems);
